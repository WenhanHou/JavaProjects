...
public class AstarSearchAlgrithom {
	...
	public static void main(String[] args) {
        ...
        AstarSearch(n3,n13, w);
        
        List<Node> path = printPath(n13);
        int nodesNum = path.size() - 1;
        
        System.out.println("Route: " + path );
        System.out.println("cost:  " + n13.g_scores);
        System.out.println("Expanded nodes:" + nodesNum);
...
public static void AstarSearch(Node source, Node goal, float w){
    ...
    while((!queue.isEmpty())&&(!found)){
            ...
            for(Edge e : current.adjacencies){
                    ...
                    double temp_f_scores = (1 - w) * temp_g_scores + w * child.h_scores;
